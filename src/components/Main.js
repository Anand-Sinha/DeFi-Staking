        ...
        return (
            <div id='content' className='mt-3'>
                ...
                <div className='card mb-2' style={{opacity:'0.9'}}>
                    ...
                    className='mb-3'>
                        <div style={{borderSpacing:'0 lem'}}>
                            ...
                            <div className='input-group mb-4'>
                                <input ref={(input)=>{this.input = input}} type='text' placeholder='0' required></input>
                                <div className='input-group-open'>
                                    <div className='input-group-text'>
                                        <img src={tether} alt='tether' height='32px'></img>
                                        &nbsp;&nbsp;&nbsp;USDT
                                    </div>
                                </div>
                            </div>
                    ...
                    event.preventDefault()
                    this.props.unstakeTokens()}} className='btn btn-primary btn-md btn-block'>WITHDRAW</button>
